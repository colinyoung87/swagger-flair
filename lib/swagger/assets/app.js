(function(global, factory) {
    ...
    var version = "3.2.0", jQuery = function(selector, context) {
    ...
    require.register("ejs.js", function(module, exports, require) {
        ...
        function filtered(js) {
            return js.substr(1).split("|").reduce(function(js, filter) {
                var parts = filter.split(":"), name = parts.shift(), args = parts.join(":") || "";
                if (args) args = ", " + args;
        ...
        var parse = exports.parse = function(str, options) {
            ...
            for (var i = 0, len = str.length; i < len; ++i) {
                ...
                if (str.slice(i, open.length + i) == open) {
                    ...
                    var js = str.substring(i, end), start = i, include = null, n = 0;
                    if ("-" == js[js.length - 1]) {
        ...
        var compile = exports.compile = function(str, options) {
            ...
            var input = JSON.stringify(str), compileDebug = options.compileDebug !== false, client = options.client, filename = options.filename ? JSON.stringify(options.filename) : "undefined";
            if (compileDebug) {
        ...
        if (require.extensions) {
            require.extensions[".ejs"] = function(module, filename) {
                ...
                var options = {
                    filename: filename,
                    client: true
                }, template = fs.readFileSync(filename).toString(), fn = compile(template, options);
...
$(function() {
    window.Flair = {
        ...
        buildSections: function(docs) {
            var paths = docs.paths, collection, slug, fresh;
            Flair.sections = [ {
                slug: "home",
                title: "Home",
                paths: [ {
        ...
        initNavLinks: function() {
            $(document).on("click", ".nav a, .anchor", function(ev) {
                ev.preventDefault();
                var $link = $(ev.currentTarget), $right = $(".right"), href = $link.attr("href"), top = $(href).offset().top, main = $link.attr("data-main") === "true";
        ...
        onScroll: function(timeout) {
            var $right = $(".right"), $section, top = $right.scrollTop();
            $(".section > .title").each(function(i, section) {
                $section = $(section);
